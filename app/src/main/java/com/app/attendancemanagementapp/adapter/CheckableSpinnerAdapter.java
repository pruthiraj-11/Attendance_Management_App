...
public class CheckableSpinnerAdapter<T> extends BaseAdapter {
   ...
   public CheckableSpinnerAdapter(Context context, String headerText, List<SpinnerItem<T>> all_items,List<SpinnerCode<T>> course_code, Set<T> selected_items,Set<T> selected_course) {
