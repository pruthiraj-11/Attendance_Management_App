...
import com.app.attendancemanagementapp.view.fragment.TeacherFragment;
...
public class TeacherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState==null){
            getSupportFragmentManager().beginTransaction().replace(R.id.teacher_fragment_container,new TeacherFragment()).commit();
        }
        ...
        teacher_nav_view.setNavigationItemSelectedListener(menuItem -> {
