...
public class CourseDeptctivity extends AppCompatActivity {
    ...
    private final List<String> cDeptList =new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //temp code
        ArrayAdapter<String> arrayAdapter=new ArrayAdapter<>(CourseDeptctivity.this,android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.department));
